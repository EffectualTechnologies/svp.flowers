...
class SYN_Packing {
	...
	public function __construct() {
		include_once( 'class-syn-packing-box.php' );
		include_once( 'class-syn-packing-item.php' );
	}
	...
	public function add_item( $length, $width, $height, $weight, $value = '', $meta = array() ) {
		$this->items[] = new SYN_Packing_Item( $length, $width, $height, $weight, $value, $meta );
	}
	...
	public function add_box( $box ) {
		$this->boxes[] = new SYN_Packing_Box( $box );
	}
