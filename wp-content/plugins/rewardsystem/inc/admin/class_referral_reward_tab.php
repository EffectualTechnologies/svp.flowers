...
class RSReferralRewardLog {
    ...
    public function __construct() {
        ...
        add_action('woocommerce_rs_settings_tabs_rewardsystem_referrallog', array($this, 'reward_system_register_admin_settings'));// Call to register the admin settings in the Reward System Submenu with general Settings tab        
        
        add_action('woocommerce_update_options_rewardsystem_referrallog', array($this, 'reward_system_update_settings'));// call the woocommerce_update_options_{slugname} to update the reward system                               
    }
    ...
    public static function reward_system_default_settings() {
        global $woocommerce;
        foreach (RSReferralRewardLog::reward_system_admin_fields() as $setting)
