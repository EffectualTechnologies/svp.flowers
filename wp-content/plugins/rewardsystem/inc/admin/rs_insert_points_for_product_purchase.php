                                    ...
                                    if(($restrictuserpoints != '') && ($restrictuserpoints != '0')){
                                        ...
                                        if($getoldpoints <= $restrictuserpoints){                                            
                                            ...
                                            if($totalpointss <= $restrictuserpoints){
                                                ...
                                                self::rs_function_to_total_earned_point_for_order($order_id,$productlevelrewardpointss);
                                            }else{
                                                ...
                                                self::rs_function_to_total_earned_point_for_order($order_id,$insertpoints);
                                            }
                                        }else{
                                    ...
                                    if(($restrictuserpoints != '') && ($restrictuserpoints != '0')){
                                        ...
                                        if($getoldpoints <= $restrictuserpoints){
                                            ...
                                            if($totalpointss <= $restrictuserpoints){
                                                ...
                                                self::rs_function_to_total_earned_point_for_order($order_id,$productlevelrewardpercentss);
                                            }else{
                                                $insertpoints = $restrictuserpoints - $getoldpoints;
                                                RSPointExpiry::insert_earning_points($orderuserid, $insertpoints,$pointsredeemed, $date,'MREPFU',$order_id,$totalearnedpoints,$totalredeempoints);
                                                $equearnamt = RSPointExpiry::earning_conversion_settings($insertpoints);
                                    ...
                                    if(($restrictuserpoints != '') && ($restrictuserpoints != '0')){
                                        ...
                                        if($getoldpoints <= $restrictuserpoints){
                                            ...
                                            if($totalpointss <= $restrictuserpoints){
                                                ...
                                                self::rs_function_to_total_earned_point_for_order($order_id,$categorylevelrewardpointss);
                                            }else{
                                                $insertpoints = $restrictuserpoints - $getoldpoints;
                                                RSPointExpiry::insert_earning_points($orderuserid, $insertpoints,$pointsredeemed, $date,'MREPFU',$order_id,$totalearnedpoints,$totalredeempoints);
                                                $equearnamt = RSPointExpiry::earning_conversion_settings($insertpoints);
                                    ...
                                    if(($restrictuserpoints != '') && ($restrictuserpoints != '0')){
                                        ...
                                        if($getoldpoints <= $restrictuserpoints){
                                            ...
                                            if($totalpointss <= $restrictuserpoints){
                                                ...
                                                self::rs_function_to_total_earned_point_for_order($order_id,$categorylevelrewardpercents);
                                            }else{
                                                $insertpoints = $restrictuserpoints - $getoldpoints;
                                                RSPointExpiry::insert_earning_points($orderuserid, $insertpoints,$pointsredeemed, $date,'MREPFU',$order_id,$totalearnedpoints,$totalredeempoints);
                                                $equearnamt = RSPointExpiry::earning_conversion_settings($insertpoints);
                                    ...
                                    if(($restrictuserpoints != '') && ($restrictuserpoints != '0')){
                                        ...
                                        if($getoldpoints <= $restrictuserpoints){
                                            ...
                                            if($totalpointss <= $restrictuserpoints){
                                                ...
                                                self::rs_function_to_total_earned_point_for_order($order_id,$global_rewardpointss);
                                            }else{
                                                $insertpoints = $restrictuserpoints - $getoldpoints;
                                                RSPointExpiry::insert_earning_points($orderuserid, $insertpoints,$pointsredeemed, $date,'MREPFU',$order_id,$totalearnedpoints,$totalredeempoints);
                                                $equearnamt = RSPointExpiry::earning_conversion_settings($insertpoints);
                                    ...
                                    if(($restrictuserpoints != '') && ($restrictuserpoints != '0')){
                                        ...
                                        if($getoldpoints <= $restrictuserpoints){
                                            ...
                                            if($totalpointss <= $restrictuserpoints){
                                                ...
                                                self::rs_function_to_total_earned_point_for_order($order_id,$global_rewardpercents);
                                            }else{
                                                $insertpoints = $restrictuserpoints - $getoldpoints;
                                                RSPointExpiry::insert_earning_points($orderuserid, $insertpoints,$pointsredeemed, $date,'MREPFU',$order_id,$totalearnedpoints,$totalredeempoints);
                                                $equearnamt = RSPointExpiry::earning_conversion_settings($insertpoints);
