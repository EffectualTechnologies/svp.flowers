        ...
        <ul class="yottie-admin-page-activation-benefits-list">
            <li class="yottie-admin-page-activation-benefits-list-item-live-updates yottie-admin-page-activation-benefits-list-item">
                ...
                <div class="yottie-admin-page-activation-benefits-list-item-info">
                    <div class="yottie-admin-page-activation-benefits-list-item-title yottie-admin-subheading-1"><?php _e('Simple Live Updates', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></div>

                    <div class="yottie-admin-page-activation-benefits-list-item-description yottie-admin-caption"><?php _e('Always be aware of fresh updates and download them easily and quickly right from your admin panel.', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></div>
                </div>
            </li>
            ...
            <li class="yottie-admin-page-activation-benefits-list-item-support yottie-admin-page-activation-benefits-list-item">
                ...
                <div class="yottie-admin-page-activation-benefits-list-item-info">
                    <div class="yottie-admin-page-activation-benefits-list-item-title yottie-admin-subheading-1"><?php _e('Fast & Premium Support', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></div>

                    <div class="yottie-admin-page-activation-benefits-list-item-description yottie-admin-caption"><?php _e('Get our direct support in the fastest way. We are ready to help you 24/7 with your issues and questions.', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></div>
                </div>
            </li>
        </ul>
    </div>
	...
	<div class="yottie-admin-page-activation-form-container">
        <form class="yottie-admin-page-activation-form" data-nonce="<?php echo wp_create_nonce('elfsight_yottie_update_activation_data_nonce'); ?>" data-activation-url="<?php echo ELFSIGHT_YOTTIE_UPDATE_URL; ?>" data-activation-slug="<?php echo ELFSIGHT_YOTTIE_SLUG; ?>" data-activation-version="<?php echo ELFSIGHT_YOTTIE_VERSION; ?>">
            ...
            <div class="yottie-admin-page-activation-form-field">
                <label>
                    <span class="yottie-admin-page-activation-form-field-label yottie-admin-caption"><?php _e('Please enter your CodeCanyon Yottie purchase code', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></span>
        ...
        <div class="yottie-admin-page-activation-faq">
            ...
            <ul class="yottie-admin-page-activation-faq-list">
                <li class="yottie-admin-page-activation-faq-list-item">
                    <div class="yottie-admin-page-activation-faq-list-item-title yottie-admin-subheading-1"><?php _e('What is item purchase code?', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></div>
                    <div class="yottie-admin-page-activation-faq-list-item-text yottie-admin-caption">
                ...
                <li class="yottie-admin-page-activation-faq-list-item">
                    <div class="yottie-admin-page-activation-faq-list-item-title yottie-admin-subheading-1"><?php _e('How to get purchase code?', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></div>
                    <div class="yottie-admin-page-activation-faq-list-item-text yottie-admin-caption">
