...
class Woo_Slg_Login_Buttons extends WP_Widget {
	...
	function Woo_Slg_Login_Buttons() {	
		...
		/* Create the widget. */
		//$this->WP_Widget( 'woo-slg-login-buttons', __( 'WooCommerce - Social Login', 'wooslg' ), $widget_ops );
		WP_Widget::__construct( 'woo-slg-login-buttons', __( 'WooCommerce - Social Login', 'wooslg' ), $widget_ops );
	}
