...
class Mk_Image_Resize
{
     ...
     *
     */
    public static function get_bg_res_set($landscape_url = false, $portrait_url = false) {
        $ref = [];
        ...
        if($has_local_landscape) {
            ...
            $ref['landscape'] = [];
            $ref['landscape']['desktop'] = ($image_actual_width > 1920) ? wp_get_attachment_image_src ( $landscape_id, 'landscape-desktop', false )[0] : $original_image_url;
