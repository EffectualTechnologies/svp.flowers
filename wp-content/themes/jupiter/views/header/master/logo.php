...
if (!empty($logo) || !empty($sticky_logo)) {
    ...
    ?>
	    ...
	    <a href="<?php echo home_url(); ?>" title="<?php bloginfo('name'); ?>">
			             ...
			             <img class="mk-desktop-logo dark-logo" title="<?php bloginfo('description'); ?>" alt="<?php bloginfo('description'); ?>" src="<?php echo $logo; ?>" />
			    
			    <?php if ($light_logo) { ?>
			             <img class="mk-desktop-logo light-logo" title="<?php bloginfo('description'); ?>" alt="<?php bloginfo('description'); ?>" src="<?php echo $light_logo; ?>" />
			    <?php } ?>
			    
			    <?php if ($mobile_logo && !$is_nav_item) { ?>
			             <img class="mk-resposnive-logo" title="<?php bloginfo('description'); ?>" alt="<?php bloginfo('description'); ?>" src="<?php echo $mobile_logo; ?>" />
			    <?php } ?>
			    
			    <?php if ($sticky_logo) { ?>
			             <img class="mk-sticky-logo" title="<?php bloginfo('description'); ?>" alt="<?php bloginfo('description'); ?>" src="<?php echo $sticky_logo; ?>" />
			    <?php } ?>
	    </a>
    </<?php echo $tag; ?>>
<?php } else { ?>
