...
<form class="cart" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button shop-skin-btn shop-flat-btn alt"><i class="mk-moon-cart-plus"></i><?php echo $product->single_add_to_cart_text(); ?></button>
