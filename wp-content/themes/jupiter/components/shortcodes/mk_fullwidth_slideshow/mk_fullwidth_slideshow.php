...
<div id="fullwidth-slideshow-wrapper-<?php echo $id; ?>">
	<div id="fullwidth-slideshow-<?php echo $id; ?>" class="mk-fullwidth-slideshow mk-script-call mk-flexslider js-flexslider <?php echo $parallax.$el_class; ?>" <?php echo implode(' ', $slider_atts); ?>>
